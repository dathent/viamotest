 ...
 */
class Viamo_Test_Block_Adminhtml_Manager extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    /**
     * Class constructor
     */
    public function __construct()
    {
        ...
        $this->_headerText = Mage::helper('viamo_test')->__('Things');
        $this->_addButtonLabel = Mage::helper('viamo_test')->__('Add New Thing');
        parent::__construct();
    }
    /**
     * Header CSS class
